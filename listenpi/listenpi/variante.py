...
if __name__ == "__main__":
    while True:
        ...
        print(" 4 - Cambiar IP estatica WLAN del dispositivo ")
        print(" 5 - Cambiar IP estatica ETHERNET del dispositivo ")
        print(" 6 - Cambiar PUERTO de conexion del portal ")
        print(" 7 - Ingresar IP y PUERTO en la Base de datos del dispotivo ")
        print(" 10 - Salir ")
        print("\n")
